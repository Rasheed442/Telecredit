    ...
    <div className="p-6">
      ...
      <div className="bg-white rounded-sm border border-gray-200 overflow-hidden">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-gray-400 text-xs font-medium bg-gray-50">
              ...
              <th className="text-left px-6 py-3">Exposure</th>
              <th className="text-left px-6 py-3">Default Count</th>
            </tr>
          </thead>
          <tbody>
            {riskCustomers.map((c) => (
